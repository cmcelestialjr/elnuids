...
'<table id="designationTable" class="table table-bordered table-fixed"'+
    ...
    '<thead>'+
        '<tr>'+
            ...
            '<th data-field="f3" data-sortable="true" data-align="center">Office</th>'+
            '<th data-field="f4" data-sortable="true" data-align="center">Current</th>'+
...
$(document).off('click', '#designationLink').on('click', '#designationLink', function (e) {
    ...
    $('#designationScript').html('');
    $('#designationScript').html('<script src="'+base_url+'/assets/js/hrims/designation/new.js"></script><script src="'+base_url+'/assets/js/hrims/designation/edit.js"></script>');
});
