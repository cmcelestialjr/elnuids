...
$(document).off('click', '.olViewOptions').on('click', '.olViewOptions', function (e) {
    olViewOptions($(this));
});
...
function olAddEmployee(thisBtn){
    var option = $('#overLoadOption').val();
...
function olViewOptions(thisBtn){
    var id = thisBtn.data('id');
    var option_id = thisBtn.data('o');
    var work_id = thisBtn.data('w');
...
function olUpdateSubmit(thisBtn){
    var id = thisBtn.data('id');
    var work_id = thisBtn.data('w');
    var sy = $('#overLoadSY option:selected').val();
...
function olRemoveSubmit(thisBtn){
    var sy = $('#overLoadSY option:selected').val();
